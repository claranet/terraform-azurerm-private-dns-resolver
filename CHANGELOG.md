...
* **tflint:** 🐛 bump Azure rules version, fix signature bug 2a6c0e1

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 03da92b
* **deps:** update dependency opentofu to v1.12.2 56f66d7
* **deps:** update dependency opentofu to v1.12.3 5ef893a
* **deps:** update dependency opentofu to v1.12.4 c1eccc3
* **deps:** update dependency tflint to v0.63.1 24ead43
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 93eb4b2
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 174e292

## 8.2.5 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ c890838

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu 102f594
* **deps:** update dependency opentofu to v1.11.7 99ca475
* **deps:** update dependency opentofu to v1.12.0 8b81332
* **deps:** update dependency terraform-docs to v0.23.0 6a94592
* **deps:** update dependency terraform-docs to v0.24.0 c9c0b9f
* **deps:** update dependency tflint to v0.62.1 13a35bc
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 8192392
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 625e38f
* **pre-commit:** 🔧 move to prek 3a98a17
* **tfdocs:** bump tfdocs to v0.22 🔧 f91388f

## 8.2.4 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 2dc48c0

### Code Refactoring

* update module structure and Github actions 👷 38663f5

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing bff4fda
* **deps:** 🔗 bump tflint rules version f8a1129
* **deps:** update dependency trivy to v0.69.2 5109373
* **deps:** update dependency trivy to v0.69.3 7a817a1
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 888fa8e

## 8.2.3 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 22f98fb

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 620783c
* **deps:** update dependency opentofu to v1.11.2 be6874f
* **deps:** update dependency opentofu to v1.11.3 b2cf945
* **deps:** update dependency opentofu to v1.11.4 0637da1
* **deps:** update dependency opentofu to v1.11.5 5af2ebe
* **deps:** update dependency pre-commit to v4.4.0 5c7fd39
* **deps:** update dependency pre-commit to v4.5.0 0ce5837
* **deps:** update dependency pre-commit to v4.5.1 5586c49
* **deps:** update dependency tflint to v0.60.0 2648d53
* **deps:** update dependency tflint to v0.61.0 3151edb
* **deps:** update dependency trivy to v0.67.1 6281ef8
* **deps:** update dependency trivy to v0.67.2 21c56e9
* **deps:** update dependency trivy to v0.68.1 d978650
* **deps:** update dependency trivy to v0.68.2 42f5d7b
* **deps:** update dependency trivy to v0.69.0 6baae1a
* **deps:** update dependency trivy to v0.69.1 59a5172
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 d711c0c
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 f9dc232
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 f5501b0
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 1eb73b9
* **deps:** update tools 3899e66

## 8.2.2 (2025-10-01)

### Code Refactoring

* **deps:** 🔗 update claranet/azurecaf to ~> 1.3.0 🔧 442a3d9

### Miscellaneous Chores

* **deps:** 🔗 bump AzureRM provider version to v4.31+ d1af25a
* **deps:** update dependency opentofu to v1.10.6 fc589fc
* **deps:** update dependency tflint to v0.59.1 e828300
* **deps:** update dependency trivy to v0.66.0 a0b91c5
* **deps:** update dependency trivy to v0.67.0 09898bb

## 8.2.1 (2025-08-19)

### Bug Fixes

* 🐛 bump AzureRM provider version 22c8489

### Miscellaneous Chores

* **⚙️:** ✏️ update template identifier for MR review b6c7dfb
* 🗑️ remove old commitlint configuration files dab99f5
* **deps:** update dependency opentofu to v1.10.0 42441c6
* **deps:** update dependency opentofu to v1.10.1 f1256a7
* **deps:** update dependency opentofu to v1.10.3 9744458
* **deps:** update dependency tflint to v0.58.0 f2a01c5
* **deps:** update dependency tflint to v0.58.1 17cc173
* **deps:** update dependency trivy to v0.63.0 415644f
* **deps:** update pre-commit hook pre-commit/pre-commit-hooks to v6 0a11147
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.1 4ef6ae9
* **deps:** update terraform claranet/subnet/azurerm to ~> 8.1.0 b1c4979
* **deps:** update terraform claranet/vnet/azurerm to ~> 8.1.0 c929ca8
* **deps:** update tools b686f4c
* **deps:** update tools 4d1dba3
* **deps:** update tools af5e22c
